...
JF.initialize({ apiKey: "d7a9e4ccd45b1c1c55220235d5b7ffff" }); //PUT YOUR OWN KEY HERE
 
// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223124264454046", function (response) {
...
const map = new mapboxgl.Map({
    ...
    style: "mapbox://styles/ninevehomap/cl9wu1pdd002p15s583ifqru9", // Your style URL
...
map.on("load", () => {
    ...
    new MapboxLayer({
        ...
        onClick: (info) => {
            getImageGallery(
              info.object.whatDoes, info.object.whatDo
            );
